...
SLIDES.push({
	...
	onstart: function(self){
		...
		self.add({
			...
			x:130, y:100, width:700,
			size:85, lineHeight:0.85, align:"center",
			text_id:"title"
		});
		self.add({
			id:"subtitle", type:"TextBox",
			x:267, y:340, width:420,
			align:"center", color:"#aaa", size:13,
			text_id:"subtitle"
		});
...
SLIDES.push({
	...
	onstart: function(self){
		...
		self.add({
			...
			x:130, y:60, width:700, height:400, align:"center",
			text_id:"intro"
		});
...
// MOVED: Charms explanation slides now appear AFTER governance voting (see end of A_Slides_Governance.js)
// This allows users to experience the full game→reputation→voting→rule-change loop
// BEFORE learning how Charms protocol makes it possible on Bitcoin