function SandboxUI(config) {
	...
	var yDiff = 80;
	var yOff = 40;
	_makePopulationControl(0, yOff + 0, "all_c", 8);
	_makePopulationControl(xDiff, yOff + 0, "tft", 5);
	_makePopulationControl(0, yOff + yDiff, "tf2t", 5);
	_makePopulationControl(xDiff, yOff + yDiff, "all_d", 2);
	_makePopulationControl(0, yOff + yDiff * 2, "pavlov", 2);
	_makePopulationControl(xDiff, yOff + yDiff * 2, "random", 1);
	_makePopulationControl(0, yOff + yDiff * 3, "grudge", 1);
	_makePopulationControl(xDiff, yOff + yDiff * 3, "prober", 1);
